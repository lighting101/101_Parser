...
import {loggerModule, logstashHost, logstashPort} from "../config";
...
export default function LogFactory (moduleName:string):ILog {
    switch (loggerModule) {
        ...
        case "Logstash": return new LogElastic(moduleName, logstashHost, logstashPort);
        case "MySQL": return new LogDB(moduleName);
        case "LogElasticConsole": return new LogElasticConsole(moduleName, logstashHost, logstashPort);
